...
public class StripedAtomicCountersRepositoryTest implements MapBasedCountersRepositoryTest<AtomicLong> {

    private final StripedAtomicCountersRepository repository = new StripedAtomicCountersRepository();
